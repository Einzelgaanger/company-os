...
export function buildSeed(): SeedData {
  ...
  const meetings: Meeting[] = [
    ...
    },
    {
      ...
      org_id: ORG,
      source: "fathom",
      external_id: "fathom-payroll-hold",
      title: "1:1 — payroll and leave",
      sensitivity: "internal",
      tag_ids: [],
      classified_by: null,
      privacy_held: true,
      ...
      occurred_at: iso(-1, 16),
      ingested_at: iso(-1, 16),
      processed_at: null,
      extracted_commitments_count: 0,
      category: null,
    },
  ...
  const reports: Report[] = [
    {
      ...
      content_md: [
        "## Weekly team pulse — Wanjiru's line",
        "",
        `Week of ${dateOnly(-7)} to ${dateOnly(-1)}. **5 of 6 people answered**, giving 19 answers across 5 questions a day.`,
        "",
        "### What came up repeatedly",
        "",
        "**Approvals outside the team are the main wait** — 6 mentions.",
        "Sign-off from finance and legal is the most frequently named source of delay. Several people described approvals sitting for over a week with no way to see where they are.",
        "",
        "**Validation work was under-scoped** — 4 mentions.",
        "The data validation step on VGG is consistently described as larger than what was planned for.",
        "",
        "**Cutover checklist has no clear owner** — 3 mentions.",
        "More than one person believes someone else owns the final checklist.",
        "",
        "### Questions asked this week",
        "",
        "- What are you waiting on from another team right now? (dependencies, 5 answers)",
        "- What is slowing you down that nobody has asked about? (blockers, 5 answers)",
        "- Where are you unsure who owns a piece of work? (clarity, 4 answers)",
        "",
        "### Tone",
        "",
        "21% positive, 42% neutral, 37% negative. Negative tone is concentrated in answers about waiting on other teams, not about the work itself.",
        "",
        "### Suggested next step",
        "",
        "Two of the three themes are about ownership and waiting rather than capacity. Naming an owner for the cutover checklist and agreeing a response time for cross-team approvals would address the majority of what was raised.",
      ].join("\n"),
    },
    {
      id: "r-daily-1",
  ...
  const survey_aggregates: SurveyAggregate[] = [
    ...
    {
      id: "sag-line-wanjiru-w1",
      org_id: ORG,
      scope_type: "manager_line",
      scope_key: U.wanjiru,
      scope_label: "Wanjiru's line",
      period_start: dateOnly(-7),
      period_end: dateOnly(-1),
      respondent_count: 5,
      response_count: 19,
      invited_count: 6,
      themes: [
        { theme: "Approvals outside the team are the main wait", mentionCount: 6, exampleParaphrase: "Sign-off from finance and legal is the most frequently named source of delay." },
        { theme: "Validation work was under-scoped", mentionCount: 4 },
        { theme: "Cutover checklist has no clear owner", mentionCount: 3 },
      ],
      questions_asked: [
        { question: "What are you waiting on from another team right now?", topic: "dependencies", answers: 5 },
        { question: "What is slowing you down that nobody has asked about?", topic: "blockers", answers: 5 },
        { question: "Where are you unsure who owns a piece of work?", topic: "clarity", answers: 4 },
      ],
      sentiment_positive_pct: 21,
      sentiment_neutral_pct: 42,
      sentiment_negative_pct: 37,
