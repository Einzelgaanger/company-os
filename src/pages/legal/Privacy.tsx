          ...
          body: (
            <>
              ...
              <ul>
                ...
                <li>
                  <strong>Messages we send or receive for coordination</strong> — Telegram (primary), with
                  WhatsApp or email as fallback, plus in-app notices. Message bodies are work check-ins, not
                  general chat.
                </li>
                <li>
          ...
          body: (
            <>
              ...
              <ul>
                ...
                <li>Telegram, WhatsApp, or email providers for check-ins you enabled.</li>
