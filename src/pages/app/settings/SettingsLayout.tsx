...
const ITEMS: Item[] = [
  ...
  { to: "/settings/coordination", label: "Coordination", minRole: "admin" },
  { to: "/settings/roles", label: "People & roles", minRole: "admin" },
  { to: "/settings/teams", label: "Teams", minRole: "admin" },
  { to: "/settings/ownership-map", label: "Ownership map", minRole: "admin" },
  { to: "/settings/data-governance", label: "Ingestion rules", minRole: "admin" },
