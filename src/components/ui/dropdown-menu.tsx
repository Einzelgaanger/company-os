...
>(({ className, sideOffset = 4, ...props }, ref) => (
  <DropdownMenuPrimitive.Portal>
    <DropdownMenuPrimitive.Content
      ...
      className={cn(
        "z-50 min-w-[10rem] overflow-hidden rounded-md border border-border bg-surface p-1 text-ink shadow-md data-[state=open]:animate-in data-[state=open]:fade-in-0",
        className
      )}
      {...props}
    />
